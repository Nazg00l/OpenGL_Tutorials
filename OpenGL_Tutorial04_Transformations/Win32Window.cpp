	...
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		*/
		...
		// This how we change the value of a uniform variable in the the shader
		// which is in this code refers to the variable "transform" in core.vs 
		// So first we get its location in the program (after we compiled it and linkk the shaders to it)
		// then we update the value using that location with the function glUniform****
		GLint tranformLocation = glGetUniformLocation(ourShader.Program, "transform");
